...
00000000004010e0 <main>:
  ...
  401290:	e8 27 0c 00 00       	callq  401ebc <stable_launch>
...
0000000000401802 <getbuf>:
  ...
  401809:	e8 2c 02 00 00       	callq  401a3a <Gets>
...
0000000000401818 <touch1>:
  ...
  40181c:	c7 05 d6 2c 20 00 01 	movl   $0x1,0x202cd6(%rip)        # 6044fc <vlevel>
  401823:	00 00 00 
  401826:	bf 74 2f 40 00       	mov    $0x402f74,%edi
  40182b:	e8 20 f4 ff ff       	callq  400c50 <puts@plt>
  401830:	bf 01 00 00 00       	mov    $0x1,%edi
  401835:	e8 ef 03 00 00       	callq  401c29 <validate>
...
000000000040189a <hexmatch>:
  ...
  4018e5:	be 91 2f 40 00       	mov    $0x402f91,%esi
...
0000000000401918 <touch3>:
  ...
  40191c:	c7 05 d6 2b 20 00 03 	movl   $0x3,0x202bd6(%rip)        # 6044fc <vlevel>
  401923:	00 00 00 
  401926:	48 89 fe             	mov    %rdi,%rsi
  401929:	8b 3d d5 2b 20 00    	mov    0x202bd5(%rip),%edi        # 604504 <cookie>
...
000000000040197c <test>:
  ...
  40198c:	bf 38 30 40 00       	mov    $0x403038,%edi
...
0000000000401e3b <launch>:
  ...
  401e8e:	e8 e9 fa ff ff       	callq  40197c <test>
...
000000000040292a <init_driver>:
  ...
  4029c9:	bf 25 34 40 00       	mov    $0x403425,%edi
  ...
  402a6c:	66 c7 44 24 02 1f 55 	movw   $0x551f,0x2(%rsp)
...
0000000000402af3 <driver_post>:
  ...
  402b03:	bf 2f 34 40 00       	mov    $0x40342f,%edi
  ...
  402b3c:	be 55 1f 00 00       	mov    $0x1f55,%esi
  402b41:	bf 25 34 40 00       	mov    $0x403425,%edi
...
0000000000402bc0 <__libc_csu_init>:
  ...
  402bd1:	4c 8d 25 38 12 20 00 	lea    0x201238(%rip),%r12        # 603e10 <__frame_dummy_init_array_entry>
  402bd8:	55                   	push   %rbp
  402bd9:	48 8d 2d 38 12 20 00 	lea    0x201238(%rip),%rbp        # 603e18 <__init_array_end>
  402be0:	53                   	push   %rbx
