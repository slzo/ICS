...
func_rev:     file format elf64-x86-64
...
0000000000001060 <_start>:
    ...
    1081:	48 8d 3d 05 01 00 00 	lea    0x105(%rip),%rdi        # 118d <main>
...
0000000000001149 <fibo>:
    1149:	f3 0f 1e fa          	endbr64 
    114d:	55                   	push   %rbp
    114e:	53                   	push   %rbx
    114f:	48 83 ec 08          	sub    $0x8,%rsp
    1153:	89 fb                	mov    %edi,%ebx
    1155:	85 ff                	test   %edi,%edi
    1157:	74 20                	je     1179 <fibo+0x30>
    1159:	83 ff 01             	cmp    $0x1,%edi
    115c:	74 24                	je     1182 <fibo+0x39>
    115e:	83 ff 02             	cmp    $0x2,%edi
    1161:	74 23                	je     1186 <fibo+0x3d>
    1163:	8d 7f ff             	lea    -0x1(%rdi),%edi
    1166:	e8 de ff ff ff       	callq  1149 <fibo>
    116b:	89 c5                	mov    %eax,%ebp
    116d:	8d 7b fe             	lea    -0x2(%rbx),%edi
    1170:	e8 d4 ff ff ff       	callq  1149 <fibo>
    1175:	01 e8                	add    %ebp,%eax
    1177:	eb 02                	jmp    117b <fibo+0x32>
    1179:	89 f8                	mov    %edi,%eax
    117b:	48 83 c4 08          	add    $0x8,%rsp
    117f:	5b                   	pop    %rbx
    1180:	5d                   	pop    %rbp
    1181:	c3                   	retq   
    1182:	89 f8                	mov    %edi,%eax
    1184:	eb f5                	jmp    117b <fibo+0x32>
    1186:	b8 01 00 00 00       	mov    $0x1,%eax
    118b:	eb ee                	jmp    117b <fibo+0x32>

000000000000118d <main>:
    118d:	f3 0f 1e fa          	endbr64 
    1191:	48 83 ec 08          	sub    $0x8,%rsp
    1195:	bf 05 00 00 00       	mov    $0x5,%edi
    119a:	e8 aa ff ff ff       	callq  1149 <fibo>
    ...
    11b2:	e8 99 fe ff ff       	callq  1050 <__printf_chk@plt>
