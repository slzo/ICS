...
0000000000001080 <_start>:
    ...
    10a1:	48 8d 3d f2 00 00 00 	lea    0xf2(%rip),%rdi        # 119a <main>
...
0000000000001169 <eight_arguements>:
    1169:	f3 0f 1e fa          	endbr64 
    116d:	53                   	push   %rbx
    116e:	4c 8b 17             	mov    (%rdi),%r10
    1171:	48 63 06             	movslq (%rsi),%rax
    1174:	48 0f bf 1a          	movswq (%rdx),%rbx
    1178:	4c 0f be 19          	movsbq (%rcx),%r11
    117c:	4c 89 07             	mov    %r8,(%rdi)
    117f:	44 89 0e             	mov    %r9d,(%rsi)
    1182:	8b 74 24 10          	mov    0x10(%rsp),%esi
    1186:	66 89 32             	mov    %si,(%rdx)
    1189:	8b 54 24 18          	mov    0x18(%rsp),%edx
    118d:	88 11                	mov    %dl,(%rcx)
    118f:	4c 01 d0             	add    %r10,%rax
    1192:	48 01 d8             	add    %rbx,%rax
    1195:	4c 01 d8             	add    %r11,%rax
    1198:	5b                   	pop    %rbx
    1199:	c3                   	retq   
...
000000000000119a <main>:
    ...
    11a3:	bb 28 00 00 00       	mov    $0x28,%ebx
    11a8:	64 48 8b 03          	mov    %fs:(%rbx),%rax
    11ac:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    11b1:	31 c0                	xor    %eax,%eax
    11b3:	48 c7 44 24 10 64 00 	movq   $0x64,0x10(%rsp)
    11ba:	00 00 
    11bc:	c7 44 24 0c c8 00 00 	movl   $0xc8,0xc(%rsp)
    11c3:	00 
    11c4:	66 c7 44 24 0a 2c 01 	movw   $0x12c,0xa(%rsp)
    11cb:	c6 44 24 09 0a       	movb   $0xa,0x9(%rsp)
    11d0:	48 8d 4c 24 09       	lea    0x9(%rsp),%rcx
    11d5:	48 8d 54 24 0a       	lea    0xa(%rsp),%rdx
    11da:	48 8d 74 24 0c       	lea    0xc(%rsp),%rsi
    11df:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi
    11e4:	6a 0a                	pushq  $0xa
    11e6:	68 2c 01 00 00       	pushq  $0x12c
    11eb:	41 b9 c8 00 00 00    	mov    $0xc8,%r9d
    11f1:	41 b8 64 00 00 00    	mov    $0x64,%r8d
    11f7:	e8 6d ff ff ff       	callq  1169 <eight_arguements>
    ...
    1210:	e8 5b fe ff ff       	callq  1070 <__printf_chk@plt>
    1215:	48 83 c4 10          	add    $0x10,%rsp
    1219:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    121e:	64 48 33 03          	xor    %fs:(%rbx),%rax
    1222:	75 0b                	jne    122f <main+0x95>
    1224:	b8 00 00 00 00       	mov    $0x0,%eax
    1229:	48 83 c4 20          	add    $0x20,%rsp
    122d:	5b                   	pop    %rbx
    122e:	c3                   	retq   
    122f:	e8 2c fe ff ff       	callq  1060 <__stack_chk_fail@plt>
    1234:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    123b:	00 00 00 
